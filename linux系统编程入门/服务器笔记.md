...
- [第二章 Linux多进程开发](#第二章-linux多进程开发)
  ...
  - [进程间通信](#进程间通信)
    ...
    - [SIGCHLD信号](#sigchld信号)
    - [MAC地址（Media Access Control Address）](#mac地址media-access-control-address)
    - [端口](#端口)
    - [网络模型](#网络模型)
      - [OSI七层参考模型](#osi七层参考模型)
...
#### OSI七层参考模型
![图 42](../images/da6bb2f69d7ff849b0a459a993791efe4b02ef33f966e370ee1f7e4c6645c177.png)  
物数网传会表应
- 数据链路层与MAC地址有关
- 网络层与ip地址有关
...
![图 41](../images/dfd0480d4a946e75c4c0c0fc27c2143277a90d921d75dce8709848c1695d53cf.png)  
